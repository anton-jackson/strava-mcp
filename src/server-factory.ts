...
/**
 * Initialize the Strava client (refreshes token on startup)
 */
export async function initializeStrava(): Promise<void> {
  const stravaClient = new StravaClient();
  try {
...
/**
 * Create and configure an MCP server with all Strava tools registered
 */
